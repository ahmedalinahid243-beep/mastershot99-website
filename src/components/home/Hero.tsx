...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-grid">
      ...
      {/* animated moving candlestick ticker along the bottom */}
      <div className="pointer-events-none absolute bottom-0 left-0 w-full h-40 sm:h-52 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-t from-void via-void/70 to-transparent z-10" />
        <LiveTicker className="w-full h-full opacity-80" />
      </div>
